...
> ai 提示词
>
> 我需要您提取文件中的目录，要求提取所有目录。输出格式要求如下：
> 目录级别 "目录文字" 页码
> 其中目录级别从 0 开始，一级目录是0，二级目录是1，不要出现跳跃
> 目录文字不要包含双引号
> 例如
> 0 "第一章 有理数" 1
...
### References non-existant pages or is malformed
...
[OOCCRR](https://www.ooccrr.com/zh-hant/a3-to-a4-split/)
