...
![ComplexJob](https://piggo-picture.oss-cn-hangzhou.aliyuncs.com/ComplexJob.png)
...
![ComplexTask](https://piggo-picture.oss-cn-hangzhou.aliyuncs.com/ComplexTask.png)
...
![Dependency](https://piggo-picture.oss-cn-hangzhou.aliyuncs.com/pipeline.png)
...
![ComplextStage](https://piggo-picture.oss-cn-hangzhou.aliyuncs.com/ComplexJobStage.png)
...
![cartesian](https://piggo-picture.oss-cn-hangzhou.aliyuncs.com/cartesianPipeline.png)
...
![MapReduce](https://piggo-picture.oss-cn-hangzhou.aliyuncs.com/MapReduce.png)
